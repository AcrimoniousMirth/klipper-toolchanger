...
```
wget -O - https://raw.githubusercontent.com/AcrimoniousMirth/klipper-toolchanger.git/main/install.sh | bash
```
...
origin: https://github.com/AcrimoniousMirth/klipper-toolchanger.git
